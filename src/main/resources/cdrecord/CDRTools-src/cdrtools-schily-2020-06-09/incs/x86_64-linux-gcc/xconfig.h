...
/* @(#)xconfig.h.in	1.280 19/11/21 Copyright 1998-2019 J. Schilling */
/*
...
/* #undef HAVE_EXPAT_H */		/* if we may include expat.h */
...
/* #undef HAVE_XML_PARSE */		/* whether XML_Parse() libc or -lexpat */
...
#define	CNF_PATH_ED "/bin/ed"		/* e.g. "/bin/ed" */
#define	CNF_PATH_RED "/bin/red"		/* e.g. "/bin/red" */
