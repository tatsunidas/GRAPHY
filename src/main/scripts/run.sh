...
JVM_OPTS="$JVM_OPTS --add-exports java.base/java.lang=ALL-UNNAMED"
JVM_OPTS="$JVM_OPTS --add-exports java.desktop/sun.awt=ALL-UNNAMED"
JVM_OPTS="$JVM_OPTS --add-exports java.desktop/sun.java2d=ALL-UNNAMED"
JVM_OPTS="$JVM_OPTS --add-exports java.base/sun.security.action=ALL-UNNAMED"
# For dcm4che imageio
