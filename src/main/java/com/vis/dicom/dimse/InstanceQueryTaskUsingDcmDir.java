...
class InstanceQueryTaskUsingDcmDir extends SeriesQueryTaskUsingDcmDir {

    protected final String[] sopIUIDs;
    protected Attributes instRec;

    public InstanceQueryTaskUsingDcmDir(Association as, PresentationContext pc, Attributes rq, Attributes keys, DcmQRSCP qrscp)
