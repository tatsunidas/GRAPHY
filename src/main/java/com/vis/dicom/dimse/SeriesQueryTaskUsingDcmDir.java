...
class SeriesQueryTaskUsingDcmDir extends StudyQueryTaskUsingDcmDir {

    protected final String[] seriesIUIDs;
    protected Attributes seriesRec;

    public SeriesQueryTaskUsingDcmDir(Association as, PresentationContext pc, Attributes rq, Attributes keys, DcmQRSCP qrscp)
