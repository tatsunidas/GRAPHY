...
public abstract class StoredValue {
    ...
    public static StoredValue valueOf(DicomObject attrs) {
        int bitsStored = attrs.getInt(Tag.Bits​Stored, 0);
        if (bitsStored == 0)
            bitsStored = attrs.getInt(Tag.Bits​Allocated, 8);
        return attrs.getInt(Tag.Pixel​Representation, 0) != 0
