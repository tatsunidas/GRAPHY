...
public class PaletteColorModel extends ColorModel {
    ...
    public PaletteColorModel(int bits, int dataType, ColorSpace cs,
        ...
        int[] rDesc = lutDescriptor(ds,
                Tag.Red​Palette​Color​Lookup​Table​Descriptor);
        int[] gDesc = lutDescriptor(ds,
                Tag.Green​Palette​Color​Lookup​Table​Descriptor);
        int[] bDesc = lutDescriptor(ds,
                Tag.Blue​Palette​Color​Lookup​Table​Descriptor);
        byte[] r = lutData(ds, rDesc,
                Tag.Red​Palette​Color​Lookup​Table​Data,
                Tag.Segmented​Red​Palette​Color​Lookup​Table​Data);
        byte[] g = lutData(ds, gDesc,
                Tag.Green​Palette​Color​Lookup​Table​Data,
                Tag.Segmented​Green​Palette​Color​Lookup​Table​Data);
        byte[] b = lutData(ds, bDesc, 
                Tag.Blue​Palette​Color​Lookup​Table​Data,
                Tag.Segmented​Blue​Palette​Color​Lookup​Table​Data);
    ...
    private int[] lutDescriptor(DicomObject ds, int descTag) {
    ...
    private static byte[] lutData(DicomObject ds, int[] desc, int dataTag, int segmTag) {
