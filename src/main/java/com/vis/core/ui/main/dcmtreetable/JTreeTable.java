 ...
 * 
 * TreeTableModel: Tree model
 * TreeTableModelAdapter: Table model, representing the visible rows in the tree.
 * TreeTableCellRenderer: JTree and render tree on table.
 * TreeTableCellEditor: Control tree expand.
 * 
 *
...
public class JTreeTable extends JTable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1348957606050080916L;
	/** A subclass of JTree. */
	...
	public class TreeTableCellRenderer extends JTree implements TableCellRenderer {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -5248645581795544493L;
	...
	public class TreeTableCellEditor extends AbstractCellEditor implements TableCellEditor {
		...
		public boolean isCellEditable(EventObject e) {
			// expand tree
			/*
			 * Single Click : expand by expand/close(▶) icon.
			 * Double Click : expand by node icon (e.g., folder icon).
			 */
			if (e instanceof MouseEvent) {
				for (int counter = getColumnCount() - 1; counter >= 0; counter--) {
					if (getColumnClass(counter) == TreeTableModel.class) {
						...
						MouseEvent newME = new MouseEvent(tree, me.getID(), me.getWhen(), me.getModifiers()/*When using getModifiersEx() directly, do not action properly.*/,
	...
	class ListToTreeSelectionModelWrapper extends DefaultTreeSelectionModel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -7539808485668726910L;
