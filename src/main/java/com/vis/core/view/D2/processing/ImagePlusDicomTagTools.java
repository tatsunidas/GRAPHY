...
//		String hdr = "tag1:value1\ntag2:value2\ntag3:value3";
//		int index1 = hdr.indexOf("tag2");
...
//		String im1 = "D:\\Dropbox\\Graphy-WorkSpace2\\graphy-parent\\graphy-resource\\src\\test\\resources\\dicom_samples\\LGG-104_small\\06-26-2000-MRI Hd wow-05523\\4-Gad Ax T2 Straight-38151\\000001.dcm";
//		ImagePlus imp = new ImagePlus(im1);
//		
//		ImagePlusDicomTagTools tool = new ImagePlusDicomTagTools();
//		tool.setTag(imp, "0010,0010", "GRAPHY^TOOL");
//		String name = tool.getTag(imp, "0010,0010");
